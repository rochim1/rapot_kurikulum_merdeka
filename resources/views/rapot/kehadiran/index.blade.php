                        ...
                        @forelse($kelola_kelas as $kelola)
                            @foreach($kelola->siswa as $siswa)
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" class="form-control" name="izin[{{ $siswa->id_siswa }}]" value="{{ $siswa->rapot->izin ?? '' }}" />
                                    </td>
                                    <td>
                                        <input type="number" class="form-control" name="tanpa_keterangan[{{ $siswa->id_siswa }}]" value="{{ $siswa->rapot->tanpa_keterangan ?? '' }}" />
                                    </td>
                                </tr>
                            @endforeach
                        @empty
