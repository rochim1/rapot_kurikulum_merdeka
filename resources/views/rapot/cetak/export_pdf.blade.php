                    ...
                    @foreach ($itemRapot->rapotNilai as $rapotNilai)
                        @if ($rapotNilai->mataPelajaran->kelompok != $kelompokSebelumnya)
                            ...
                            <tr style="background-color: #e9ecef;">
                                <td colspan="4" style="padding: 8px; text-align: start; font-weight: bold; font-size: 0.8rem; border: 1px solid #000;">
            ...
            <tbody>
                ...
                @empty
                    <tr style="background-color: #f0f5ff; text-align: center;">
                        <td colspan="4" style="border: 1px solid #000; padding: 10px; font-style: italic;">Tidak ada data ekstrakurikuler</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <table style="width: 100%;">
            <tr>
                ...
                <td style="text-align: right;">
                    ...
                    <br><br><br>
                    <p style="margin: 0; text-decoration: underline; font-weight: bold;">{{ $itemRapot->guru->nama }}</p>
