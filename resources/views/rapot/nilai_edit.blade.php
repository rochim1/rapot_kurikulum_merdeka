                                ...
                                <option value="">Pilih Mata Pelajaran</option>
                                    @foreach($mataPelajaran as $item_mata_pelajaran)
                                        <option value="{{ $item_mata_pelajaran->id_mata_pelajaran }}" 
                                                {{ request('id_mata_pelajaran') == $item_mata_pelajaran->id_mata_pelajaran ? 'selected' : '' }}>{{ $item_mata_pelajaran->kelompok }} - {{ $item_mata_pelajaran->nama_mata_pelajaran }}
                                        </option>
                                    @endforeach
                            </select>
                                        ...
                                        @foreach($kelola->siswa as $siswa)
                                            <tr>
                                                ...
                                                <td width="12%">
                                                    ...
                                                    <input type="hidden" name="id_mata_pelajaran[{{ $siswa->id_siswa }}]" value="{{ $id_mata_pelajaran }}">
                                                    <input type="number" class="form-control" name="nilai_akhir[{{ $siswa->id_siswa }}]" value="">
                                                </td>
                                                <td>
                                                    <div class="form-check">
                                                        @foreach($tujuan_pembelajaran as $tujuan)
                                                            <input 
                                                                class="form-check-input tujuan-tercapai" 
                                                                type="checkbox"
                                                                ...
                                                                >
                                                            <label class="form-check-label" for="tujuan_tercapai_{{ $siswa->id_siswa }}_{{ $tujuan->id_tujuan_pembelajaran }}">
                                                ...
                                                <td>
                                                    <div class="form-check">
                                                        @foreach($tujuan_pembelajaran as $tujuan)
                                                            <input 
                                                                class="form-check-input tujuan-tidak-tercapai" 
                                                                type="checkbox" 
                                                            ...
                                                            <label class="form-check-label" for="tujuan_tidak_tercapai_{{ $siswa->id_siswa }}_{{ $tujuan->id_tujuan_pembelajaran }}">
            ...
            if (checkbox.checked) {
                ...
                allCheckboxes.forEach(cb => {
                    if (cb.classList.contains('tujuan-tercapai')) {
                        cb.checked = true;
                        const relatedTidakTercapaiCheckbox = document.querySelector(`#tujuan_tidak_tercapai_${cb.dataset.siswa}_${tujuanId}`);
